    ...
    return Scaffold(
      ...
      body: GestureDetector(
        onHorizontalDragEnd: (DragEndDetails details) {
          final index = controller.persistentTabController.index;
          if ((details.primaryVelocity ?? 0) < 0 && controller.persistentTabController.index != 2 - 1) {
            controller.persistentTabController.jumpToTab(index + 1);
          } else if ((details.primaryVelocity ?? 0) > 0 && controller.persistentTabController.index != 0) {
            controller.persistentTabController.jumpToTab(index - 1);
          }
        },
